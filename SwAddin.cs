...
{
    /// <summary>
    /// Summary description for SwCSharpAddin2.
    /// </summary>
    [Guid("116f7d92-620c-4f2b-85c1-5a1c83dc61bf"), ComVisible(true)]
    [SwAddin(
        Description = "SwCSharpAddin2 description",
        Title = "SwCSharpAddin2",
        LoadAtStartup = true
        )]
    public class SwAddin : ISwAddin
    {
        ...
        public void AddCommandMgr()
        {
            ...
            icons[0] = iBmp.CreateFileFromResourceBitmap("SwCSharpAddin2.toolbar20x.png", thisAssembly);
            icons[1] = iBmp.CreateFileFromResourceBitmap("SwCSharpAddin2.toolbar32x.png", thisAssembly);
            icons[2] = iBmp.CreateFileFromResourceBitmap("SwCSharpAddin2.toolbar40x.png", thisAssembly);
            icons[3] = iBmp.CreateFileFromResourceBitmap("SwCSharpAddin2.toolbar64x.png", thisAssembly);
            icons[4] = iBmp.CreateFileFromResourceBitmap("SwCSharpAddin2.toolbar96x.png", thisAssembly);
            icons[5] = iBmp.CreateFileFromResourceBitmap("SwCSharpAddin2.toolbar128x.png", thisAssembly);

            mainIcons[0] = iBmp.CreateFileFromResourceBitmap("SwCSharpAddin2.mainicon_20.png", thisAssembly);
            mainIcons[1] = iBmp.CreateFileFromResourceBitmap("SwCSharpAddin2.mainicon_32.png", thisAssembly);
            mainIcons[2] = iBmp.CreateFileFromResourceBitmap("SwCSharpAddin2.mainicon_40.png", thisAssembly);
            mainIcons[3] = iBmp.CreateFileFromResourceBitmap("SwCSharpAddin2.mainicon_64.png", thisAssembly);
            mainIcons[4] = iBmp.CreateFileFromResourceBitmap("SwCSharpAddin2.mainicon_96.png", thisAssembly);
            mainIcons[5] = iBmp.CreateFileFromResourceBitmap("SwCSharpAddin2.mainicon_128.png", thisAssembly);
